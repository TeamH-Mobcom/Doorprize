...
import com.example.test4.Actionbar1;
import com.example.test4.List_User1;
...
public class RecyclerViewAdapter3 extends RecyclerView.Adapter<RecyclerViewAdapter3.ViewHolder>{
    ...
    //Deklarasi Variable
    private ArrayList<data_user1> listMenu;
    private Context context;

    //Membuat Konstruktor, untuk menerima input dari Database
    public RecyclerViewAdapter3(ArrayList<data_user1> listMenu, Context context) {
        this.listMenu = listMenu;
        this.context = context;
        this.listMenu = listMenu;
        this.context = context;
        listener = (List_User1)context;
    }
                ...
                alert.setItems(action,  new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int i) {
                        ...
                        */
                                ...
                                Intent intent = new Intent(view.getContext(), Actionbar1.class);
    ...
    public interface dataListener{
        void onDeleteData(data_user1 data, int position);
    }
