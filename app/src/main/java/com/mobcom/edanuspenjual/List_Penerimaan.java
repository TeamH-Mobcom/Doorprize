...
import com.mobcom.edanuspenjual.adapter.RecyclerViewAdapter2;
...
public class List_Penerimaan extends AppCompatActivity implements RecyclerViewAdapter2.dataListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Data Pesanan Pedagang");
    ...
    private void GetData(){
        ...
        reference.child("Admin").child("Pembeli").child(auth.getCurrentUser().getUid())
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        adapter = new RecyclerViewAdapter2(dataMahasiswa, List_Penerimaan.this);
            ...
            reference.child("Admin")
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(List_Penerimaan.this, "Data Berhasil Dihapus", Toast.LENGTH_SHORT).show();
                        }
                    });
