    ...
    public void onClick (View v){
        ...
        switch (v.getId()) {
            ...
            case R.id.activate:
                ...
                database.getReference().child("Admin").child("Status").child(getKey).child(getUser).
                        setValue(new data_user(getUser,succes))
                        .addOnSuccessListener(this,new OnSuccessListener() {
                            @Override
                            public void onSuccess(Object o) {

                                Toast.makeText(Actionbar.this, "Aktivasi berhasil", Toast.LENGTH_SHORT).show();

                            }
                        });
                database.getReference().child("Admin").child("CekStatus").child(getKey).
                        setValue(new data_user(getUser,succes))
                        .addOnSuccessListener(this,new OnSuccessListener() {
                            @Override
                            public void onSuccess(Object o) {
                ...
                database.getReference().child("Admin")
                        ...
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(Actionbar.this, "User telah dibanned", Toast.LENGTH_SHORT).show();
                            }
                        });
                database.getReference().child("Admin").child("CekStatus").child(getKey).
                        setValue(new data_user(getUser,getStatus))
                        .addOnSuccessListener(this,new OnSuccessListener() {
                            @Override
                            public void onSuccess(Object o) {

                                Toast.makeText(Actionbar.this, "Berhasil di nonaktifkan", Toast.LENGTH_SHORT).show();
