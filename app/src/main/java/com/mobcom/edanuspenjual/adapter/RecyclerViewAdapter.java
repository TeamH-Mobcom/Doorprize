...
import com.mobcom.edanuspenjual.List_Menu;
import com.mobcom.edanuspenjual.R;
import com.mobcom.edanuspenjual.UpdateMenu;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder>{
    ...
    public RecyclerViewAdapter(ArrayList<data_menu> listMenu, Context context) {
        this.listMenu = listMenu;
        this.context = context;
        this.listMenu = listMenu;
        this.context = context;
        listener = (List_Menu)context;
    }

    //ViewHolder Digunakan Untuk Menyimpan Referensi Dari View-View
    class ViewHolder extends RecyclerView.ViewHolder{

        private TextView Toko, Nama, Harga, User;
                ...
                alert.setItems(action,  new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int i) {
                        ...
                        */
                                ...
                                Intent intent = new Intent(view.getContext(), UpdateMenu.class);
