...
public class List_User extends AppCompatActivity implements RecyclerViewAdapter2.dataListener {
    ...
    private void GetData(){
        ...
        reference.child("Admin").child("CekStatus")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                            ...
                            data_user penerimaan = snapshot.getValue(data_user.class);
                        ...
                        adapter = new RecyclerViewAdapter2(dataMahasiswa, List_User.this);
    ...
    @Override
    public void onDeleteData(data_user data, int position) {
        /*
            ...
            reference.child("Admin")
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(List_User.this, "Data Berhasil Dihapus", Toast.LENGTH_SHORT).show();
                        }
                    });
